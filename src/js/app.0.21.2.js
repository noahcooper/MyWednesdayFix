...
(function($) {
  ...
  myWednesdayFix.comicVine = {
    apiKey: 'e21e187f67061d346687aeb81969a3fd2d1676fa', 
    ...
    getIssues: function(options) {
      ...
      $.ajax({
        ...
        url: 'http://www.comicvine.com/api/issues/' + 
             '?api_key=' + myWednesdayFix.comicVine.apiKey + 
  ...
  myWednesdayFix.utils = {
    ...
    loadView: function(options) {
      ...
      if(myWednesdayFix.data.currentView === newView) {
        ...
        myWednesdayFix.utils.hideHeadlineBack();
    ...
    showHeadlineBack: function() {
      $('#content-headline-back').addClass('transition-in');
    }, 
    
    hideHeadlineBack: function() {
      $('#content-headline-back').removeClass('transition-in');
    }, 
  ...
  myWednesdayFix.view = {
    ...
    archiveWeek: function() {
      myWednesdayFix.utils.showHeadlineBack();
  ...
  if(window.location.href.indexOf('http:') !== -1) {
    ...
    document.addEventListener('deviceready', function() {
      $('body').on('click', 'a[target="_blank"]', function(e) {
        ...
        myWednesdayFix.phonegap.loadExternalUrl($(this).attr('href'));
      });
    }, false);
  }
  ...
  /* handle onclick event for back button */
  $('#content-headline-back').click(function(e) {
    e.preventDefault();
    
    var loadViewData = {}, 
    filterWeek;
    
    switch(myWednesdayFix.data.currentView) {
      case 'viewIssue':
        if(myWednesdayFix.data.filterWeek === 0) {
          loadViewData.view = 'thisWeek';
        }
        else {
          filterWeek = myWednesdayFix.utils.getQueryParam('filterWeek');
          ...
          loadViewData.view = 'archiveWeek';
          loadViewData.data = 'filterWeek=' + myWednesdayFix.data.filterWeek;
        }
        break;
      case 'archiveWeek':
        loadViewData.view = 'archives';
        break;
      case 'viewStore':
        loadViewData.view = 'findStore';
        break;
    }
    
    if(loadViewData.view) {
      myWednesdayFix.utils.loadView(loadViewData);
    }
  });
