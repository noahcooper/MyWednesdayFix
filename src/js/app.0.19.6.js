...
(function($) {
  ...
  if(window.location.href.indexOf('http:') !== -1) {
    ...
    myWednesdayFix.phonegap = {
      ...
      loadInAppBrowser: function(url) {
        myWednesdayFix.phonegap.inAppBrowser = window.open(url, '_blank', 'location=yes');
        alert(myWednesdayFix.phonegap.inAppBrowser);
        myWednesdayFix.phonegap.inAppBrowser.addEventListener('loadstart', function() {
          alert('loadstart');
        });
      }
    };
    ...
    document.addEventListener('deviceready', function() {
      $('body').on('click', 'a[target="_blank"]', function(e) {
        ...
        myWednesdayFix.phonegap.loadInAppBrowser($(this).attr('href'));
      });
    }, false);
  }
